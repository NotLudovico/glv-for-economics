...
$x(t)$ is a solution then so is $c\,x(t)$. The economy no longer has a preferred size. The change
...
the growth rates $\dot y_i / y_i = f_i - \langle f\rangle$ never vanish. This is the persistently
