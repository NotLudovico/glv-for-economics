...
$S$ we obtain $\sigma(S) \propto S^{-1/2}$, that is $\beta = 1/2$. The measured exponent sits
far below this. The shares therefore cannot be even: $H$ has to decay more slowly than $1/S$,
...
fat-tailed because the sum in $g$ is carried by a handful of dominant units. This is the granular model,
and on the two facts it works.
...
line in $q$. The data do not follow it. Their $\zeta_q$ still rises with $q$, but more slowly
...
memory time $\tau$ of the fluctuating state. At the model's own time unit it is about four times
too steep. Read at the annual horizon of the data against a memory time of a few years, the
scale over which firm sizes are seen to revert, most of that gap closes.
